...
namespace Property.Core.Migrations
{
    ...
    [Migration("20231230002246_TextPatternIndex")]
    partial class TextPatternIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Property.Core.Model.Property", b =>
                {
                    ...
                    NpgsqlIndexBuilderExtensions.HasOperators(b.HasIndex("Location"), new[] { "varchar_pattern_ops" });
